...
- modelo de ejercicios globales y personalizados con aislamiento por usuario;
...
1. Implementar endpoints CRUD para Exercises globales y personalizados.
2. Relacionar Exercises con Workouts.
